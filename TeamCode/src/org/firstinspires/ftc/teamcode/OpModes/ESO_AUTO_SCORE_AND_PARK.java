...
@Autonomous(name = "ESO SCORE AND PARK")
public class ESO_AUTO_SCORE_AND_PARK extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //drive to stack
        MecDrive.encoderDrive(MED_SPEED, FULL_TILE_DISTANCE+HALF_TILE_DISTANCE+QUARTER_TILE_DISTANCE, FULL_TILE_DISTANCE+HALF_TILE_DISTANCE+QUARTER_TILE_DISTANCE, this);
        ...
        while (coneStackTracker > 0 && (getRuntime() < 25.0))
        {
            ...
            switch (coneStackTracker) {
                case 5: {
                    ...
                    ServoClaw.toggleClaw();
                    MecDrive.encoderDrive(MED_SPEED, -(FULL_TILE_DISTANCE+HALF_TILE_DISTANCE), -(FULL_TILE_DISTANCE+HALF_TILE_DISTANCE), this);
       ...
       /* if(Signal == 1) {
        ...
        /*MecDrive.encoderDrive(MED_SPEED, FULL_TILE_DISTANCE*2, FULL_TILE_DISTANCE*2,this);
        Lift.moveLift(1016, this);*/
